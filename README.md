...
The platform consists of three modules: (1) typesetting (meTypeset), (2) xml-processor,  (3) a WYSIWYG editor,and (4) an output generation engine.
...
(2)  A Set of utilities to process the  XML files.
