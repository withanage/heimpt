...
-   [*https://github.com/pkp/pkp-lib/issues/1503*](https://github.com/pkp/pkp-lib/issues/1503)

-   [*https://github.com/pkp/pkp-lib/issues/2163*](https://github.com/pkp/pkp-lib/issues/2163)
...
-   JSON Web Token ([*RFC 7519*](https://tools.ietf.org/html/rfc7519))
    > Web [*https://jwt.io/*](https://jwt.io/)

-   PHPJWT library which requires PHP 5.3
    > [*https://packagist.org/packages/firebase/php-jwt*](https://packagist.org/packages/firebase/php-jwt)

-   Auth middleware in pkp-lib
    > (classes/security/authorization/internal/ApiAuthorizationMiddleware.inc.php)

-   Token generation OJS (classes/user/form/APIProfileForm.inc.php)

Pull request
------------

[*https://github.com/pkp/pkp-lib/pull/2686*](https://github.com/pkp/pkp-lib/pull/2686)

Bugs
====

-   If a bogus token is given, the request fails with a 500 error. We
    > must validate that we got a valid user object after calling\
    > \$user = \$userDao-&gt;getBySetting('apiKey', \$token)

JSON - LD
=========

-   [*Wiki Description*](https://en.wikipedia.org/wiki/JSON-LD)
    > [*Specification*](https://json-ld.org/spec/latest/json-ld/) (too
    > complex )

API support for annotations
---------------------------

-   [*Specification - Open Web Annotation data
    > mode*](https://www.w3.org/TR/annotation-model/)l

-   Example

    -   api/persist/?id=[*http://anno.ub.uni-hd.../annoID&as=10.17885/heiup.hdjbo.23560/anno/annoID*](about:blank)

Swagger Documentation
=====================

[*doc
link*](https://gist.github.com/NateWr/310166836ebea9f6177be998607d1488)
